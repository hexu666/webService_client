...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.example.client.HelloWorldService {
    ...
    public com.example.client.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.client.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.client.HelloWorldSoapBindingStub _stub = new com.example.client.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.client.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.client.HelloWorldSoapBindingStub _stub = new com.example.client.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
